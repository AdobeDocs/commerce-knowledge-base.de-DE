...
1. Navigieren Sie zu [experienceleague.adobe.com](https://experienceleague.adobe.com/de).
1. Melden Sie sich mit Ihren Adobe-Anmeldedaten an.

![Anmelden bei Experience League](assets/experience_league_sign_in.png)
...
1. Um den Support-Aufnahmeprozess zu starten, stellen Sie sicher, dass Sie die entsprechende Organisation in der Dropdown-Liste Organisation ausgewählt haben (falls sichtbar). Um eine Anfrage für Adobe Commerce zu senden, wählen Sie den Organisationsnamen aus, der auf *[!DNL Commerce]* endet.
   ...
   ![select_applicable_org](assets/select_appropriate_org.png)
...
1. Füllen Sie die [Felder](https://experienceleague.adobe.com/de/docs/commerce-knowledge-base/kb/faq/support-ticket-contact-reason-descriptions) aus.
...
Sie können die von Ihnen übermittelten Commerce-Fälle anzeigen, indem Sie im Menü links auf **[!UICONTROL My Cases]** klicken. Stellen Sie sicher, dass Sie die richtige Organisation mit der Endung „(Commerce)“ ausgewählt haben.
...
Sie können die Commerce-Fälle anzeigen, *Ihnen als Beobachter hinzugefügt wurden* indem Sie im Menü links auf **[!UICONTROL My organization's cases]** klicken.
...
1. Klicken Sie unten rechts im **[!UICONTROL Escalate to management]** auf der rechten Seite des Bildschirms auf *[!UICONTROL Case Detail]* .

   ![Eskalieren an das Management](assets/escalate_to_management.png)
...
![Kommentare hinzufügen](assets/add_comments.png)

### Fall schließen {#close-case}

Um Ihren Fall zu schließen, klicken Sie unten rechts im **[!UICONTROL Close case]** auf *[!UICONTROL Case Detail]* .

![Groß-/Kleinschreibung](assets/close_case.png)
...
1. Suchen Sie den Benutzer, für den Sie den freigegebenen Zugriff widerrufen möchten, und klicken Sie ![Symbol entfernen](assets/remove_icon.png){width="25"} in der Zeile des Benutzers (**Aktionen** Spalte).
