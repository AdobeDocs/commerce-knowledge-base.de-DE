...
Weitere Informationen zur Konfigurationsverwaltung finden Sie im Abschnitt [Konfigurationsverwaltung für Store-Einstellungen](https://experienceleague.adobe.com/docs/commerce-cloud-service/user-guide/configure-store/store-settings.html?lang=de) in unserer Entwicklerdokumentation.

### Schritt 1: Deinstallieren Sie die Adobe Commerce-Software mit dem Setup:uninstall-Befehl {#setup-uninstall}
