...
Der Patch MDVA-31969 behebt das Problem, dass Bilder beim Import von zwei .csv -Produktdateien dupliziert werden. Dieser Patch ist verfügbar, wenn die Variable [Quality Patches Tool (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.0.14 ist installiert.
...
Neue Produktbilder werden im `pub/media` -Ordner beim Importieren von Produkten auch dann, wenn bereits dasselbe Bild vorhanden ist.

<u>Zu reproduzierende Schritte</u>:

1. Erstellen Sie ein Verzeichnis für Bilder: `mkdir var/import-images`
1. Bilder im Pfad hinzufügen `<install dir>/var/import-images`.
