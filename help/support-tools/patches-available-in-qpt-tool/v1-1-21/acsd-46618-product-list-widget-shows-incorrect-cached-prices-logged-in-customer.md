...
1. Wählen Sie in Adobe Commerce Admin die Option **[!UICONTROL Stores]**, dann **[!UICONTROL Configuration]**, erweitern **[!UICONTROL Sales]** und wählen Sie **[!UICONTROL Tax]**. Aktualisieren Sie die Steuereinstellungen, um die Preise einschließlich und ohne Steuern anzuzeigen.
1. Satz **[!UICONTROL Enable Cross Border Trade]** = _Ja_.
