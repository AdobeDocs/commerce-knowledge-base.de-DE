...
Der Patch MDVA-37362 behebt das Problem, dass konfigurierbare Produktoptionenwerte und Variantenattributwerte in der GraphQL-Antwort leer sind. Dieser Patch ist verfügbar, wenn das [Quality Patches Tool (QPT)](https://devdocs.magento.com/guides/v2.4/comp-mgr/patching.html#mqp) v.1.0.23 installiert ist. Bitte beachten Sie, dass das Problem in Adobe Commerce-Version 2.4.3 behoben werden soll.
...
1. **Stores** > *Einstellungen* > **Konfiguration** > **Katalog** > **Bestand** > *Optionen für den Produktbestand* > Lager verwalten: *JA*.
