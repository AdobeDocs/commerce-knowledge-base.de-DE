...
description: Dieser Unterabschnitt enthält eine detaillierte Beschreibung der Probleme, die durch die in [!UICONTROL Quality Patches Tool] (QPT) v1.1.27.
...
Dieser Unterabschnitt enthält eine detaillierte Beschreibung der Probleme, die durch die in [!UICONTROL Quality Patches Tool] (QPT) v1.1.27.
...
1. ACSD-48059: behebt das Problem mit [!UICONTROL Visual Merchandiser] wobei Händler die &quot;[!UICONTROL Match product by rule]&quot; für die [!UICONTROL Categories] -Attribut.
1. ACSD-48216: Behebt das Problem, bei dem [!UICONTROL AUTO_INCREMENT] des [!UICONTROL inventory_source_item] -Tabelle erhöht sich auf [!UICONTROL UPDATE] Vorgang.
...
1. ACSD-48404: Behebt das Problem, bei dem [!UICONTROL Remember Category Pagination] = [!UICONTROL Yes] löst beim Drücken der Zurück-Taste des Browsers einen Fehler aus.
