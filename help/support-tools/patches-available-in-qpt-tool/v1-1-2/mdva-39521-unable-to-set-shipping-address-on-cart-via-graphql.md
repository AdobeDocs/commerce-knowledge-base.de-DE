---
title: 'MDVA-39521: Versandadresse auf Warenkörben kann nicht über GraphQL festgelegt werden'
description: Der Patch MDVA-39521 löst das Problem, dass der Benutzer keine Versandadresse auf Warenkörben mit einer leeren Telefonnummer über GraphQL festlegen kann. Dieser Patch ist verfügbar, wenn das [Quality Patches Tool (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.2 installiert ist. Die Patch-ID lautet MDVA-39521. Beachten Sie, dass das Problem voraussichtlich in Adobe Commerce 2.4.4 behoben wird.
...
1. Wechseln Sie zu **Stores** > **Configuration** > **Customers** > **Customer Configuration** > **Name and Address Options** und legen Sie das Telefon anzeigen als optional fest.
1. Erstellen Sie einen leeren Warenkorb über eine GraphQL-Anfrage.
...
1. Adresse hinzufügen: GRAPHQL VARIABLES.
