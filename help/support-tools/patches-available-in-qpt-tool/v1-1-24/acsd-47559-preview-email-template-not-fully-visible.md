...
Mit dem Patch ACSD-47559 wird das Problem behoben, dass die Vorschau der E-Mail-Vorlage nicht vollständig sichtbar ist. Dieser Patch ist verfügbar, wenn [[!DNL Quality Patches Tool (QPT)]](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/announcements/commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.html?lang=de) 1.1.24 installiert ist. Die Patch-ID ist ACSD-47559. Beachten Sie, dass das Problem voraussichtlich in Adobe Commerce 2.4.6 behoben wird.
