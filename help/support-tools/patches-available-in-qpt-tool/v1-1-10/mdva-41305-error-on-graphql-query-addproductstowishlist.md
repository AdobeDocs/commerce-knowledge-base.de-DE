...
Der Patch MDVA-41305 behebt das Problem, bei dem Benutzer einen Fehler bei der GraphQL-Abfrage erhalten `addProductsToWishlist` für konfigurierbare Produkte. Dieser Patch ist verfügbar, wenn die Variable [Quality Patches Tool (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.10 installiert ist. Die Patch-ID lautet MDVA-41305. Bitte beachten Sie, dass das Problem in Adobe Commerce 2.4.5 behoben sein soll.
...
1. Versuchen Sie, ein konfigurierbares Produkt hinzuzufügen *Blau* auf die Wunschliste mit den folgenden Anweisungen zu setzen:
...
Benutzer erhalten eine *Interner Server-Fehler* als Antwort.
