...
description: Dieser Unterabschnitt enthält eine detaillierte Beschreibung der Probleme, die durch die in [!DNL Quality Patches Tool] (QPT) v1.1.26.
...
# [!DNL Quality Patches Tool] (QPT) v1.1.26 - Übersicht

Dieser Unterabschnitt enthält eine detaillierte Beschreibung der Probleme, die durch die in [!DNL Quality Patches Tool] (QPT) v1.1.26.
...
1. **ACSD-48661** (für Adobe Commerce und Magento Open Source >=2.3.7 &lt;2.4.7) - Behebung des Problems, bei dem das Kreditlimit des Unternehmens größer als 999 ist und das Kommatrennzeichen die Speicherung des Unternehmens aufgrund eines Validierungsfehlers verhindert.
