...
1. Aktivieren Sie PayPal über Braintree, wie in der [Braintree](https://experienceleague.adobe.com/en/docs/commerce-admin/stores-sales/payments/braintree?) in unserem Benutzerhandbuch beschrieben.
