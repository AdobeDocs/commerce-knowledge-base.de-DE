...
Modul richtig, ([[!UICONTROL Product Recommendations - Install and Configure]](https://experienceleague.adobe.com/en/docs/commerce-merchant-services/product-recommendations/getting-started/install-configure) Sie in unserer Entwicklerdokumentation nach.) Wenn Sie jedoch keine Empfehlungen sehen, versuchen Sie Folgendes:
...
1. Vergewissern Sie sich, dass die [[!UICONTROL indexers]](https://experienceleague.adobe.com/en/docs/commerce-operations/configuration-guide/cli/manage-indexers) (in unserer Entwicklerdokumentation) ausgeführt werden und die `Product Feed`-[!UICONTROL indexer] auf `Update by Schedule` eingestellt ist.
...
* [Überprüfen Sie die Protokolle und &#x200B;](https://experienceleague.adobe.com/en/docs/commerce/saas-data-export/logs-troubleshooting/troubleshooting-logging) Sie Fehler“ im Handbuch [!DNL SaaS] Datenexport .
