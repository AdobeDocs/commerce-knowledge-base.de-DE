...
1. Vergewissern Sie sich, dass die [[!UICONTROL indexers]](https://experienceleague.adobe.com/en/docs/commerce-operations/configuration-guide/cli/manage-indexers) (in unserer Entwicklerdokumentation) ausgeführt werden und die ```php    Product Feed    ```-[!UICONTROL indexer] auf ```php    Update by Schedule    ``` eingestellt ist.
