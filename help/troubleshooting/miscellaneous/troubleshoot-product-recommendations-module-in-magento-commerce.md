...
Modul richtig, ([[!UICONTROL Product Recommendations - Install and Configure]](https://experienceleague.adobe.com/de/docs/commerce-merchant-services/product-recommendations/getting-started/install-configure) Sie in unserer Entwicklerdokumentation nach.) Wenn Sie jedoch keine Empfehlungen sehen, versuchen Sie Folgendes:
...
1. Vergewissern Sie sich, dass die [[!UICONTROL indexers]](https://experienceleague.adobe.com/de/docs/commerce-operations/configuration-guide/cli/manage-indexers) (in unserer Entwicklerdokumentation) ausgeführt werden und die `Product Feed`-[!UICONTROL indexer] auf `Update by Schedule` eingestellt ist.
1. Bestätigen Sie, dass die Module *aktiviert* sind. Das `saas-export`-Metapaket installiert die folgenden Module, die alle aktiviert *müssen*:
...
* [Product Recommendations-Administrator-Entwicklung](https://experienceleague.adobe.com/de/docs/commerce-merchant-services/product-recommendations/developer/development-overview) in unserer Entwicklerdokumentation
* [Einführung in Produktempfehlungen](https://experienceleague.adobe.com/de/docs/commerce-merchant-services/product-recommendations/overview) im Produktempfehlungshandbuch
* [Erstellen von Produktempfehlungen](https://experienceleague.adobe.com/de/docs/commerce-merchant-services/product-recommendations/admin/create) im Produktempfehlungshandbuch
